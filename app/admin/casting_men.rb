ActiveAdmin.register Casting, as: 'CastingMen' do
  
  menu parent: 'Кастинг', label: "Чоловіки", priority: 2, html_options: {class: 'ico_0'}
  ...
  index title: "Чоловіки", link_title: "Добавити" do |f|
    selectable_column
    id_column
  ...
  form link_title: "Повернутися до списку" do |f|
    ...
    f.inputs class: "label_none right" do
      f.input :people_type, as: :hidden, input_html: {value: Casting.people_types.keys[1]}
